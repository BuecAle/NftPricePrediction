...
df_data = df[["asset_id", "collection_author", "collection_name", "name", "date", "price_usd", "seller"]]
df_image = df[["price_usd", "media"]]

file_to_save_data = "dataAtomic_" + date + "_data.csv"
file_to_save_image = "dataAtomic_" + date + "_image.csv"
df_data.to_csv("csv/" + file_to_save_data)
df_image.to_csv("csv/" + file_to_save_image)